...
using SFA.DAS.Payments.CollectionPeriod.Specs.Data.Configurations;
using SFA.DAS.Payments.CollectionPeriod.Specs.Models;
using SFA.DAS.Payments.Model.Core.Entities;

namespace SFA.DAS.Payments.CollectionPeriod.Specs.Data;
